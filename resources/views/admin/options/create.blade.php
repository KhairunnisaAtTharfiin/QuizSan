        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('Buat Opsi') }}</h1>
                    <a href="{{ route('admin.options.index') }}" class="btn btn-sm shadow-sm" style="background: #cea008; color: white;">{{ __('Kembali') }}</a>
                </div>
            </div>
            <div class="card-body">

    ...
    <!-- Content Row -->
        <div class="card">
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    @can('user_create')
                    <a href="{{ route('admin.users.create') }}" class="btn " style="background: #cea008; color: white;">
                            ...
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>
                                    @foreach($user->roles as $key => $role)
                                        <span class="badge badge-info" style="background: #cea008; color: white;">{{ $role->title }}</span>
                                    @endforeach
                                </td>
                                <td>
